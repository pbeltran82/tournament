...
def connect():
    """Connect to the PostgreSQL database.  Returns a database connection and cursor from the database connection."""
    try:
        DB = psycopg2.connect("dbname=tournament")
        cursor = DB.cursor()            
    except:
        print("Connection to database tournament was unsuccessful")
    return DB, cursor
